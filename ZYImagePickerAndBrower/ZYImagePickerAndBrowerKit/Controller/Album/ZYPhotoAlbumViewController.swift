...
class ZYAlbumBottomView: UIView {
    ...
    convenience init() {
        self.init(frame: CGRect(x: 0, y: ZYScreenHeight-ZYHomeBarHeight-44-ZYIOS13Height, width: ZYScreenWidth, height: 44+ZYHomeBarHeight), type: .normal)
    }
    
    convenience init(type: ZYAlbumBottomViewType) {
        self.init(frame: CGRect(x: 0, y: ZYScreenHeight-ZYHomeBarHeight-44-ZYIOS13Height, width: ZYScreenWidth, height: 44+ZYHomeBarHeight), type: type)
    }
